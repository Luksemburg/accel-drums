...
public class Screen extends AppCompatActivity implements SensorEventListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.accel:
                Intent intent = new Intent(Screen.this, SensorTestActivity.class);
            ...
            case R.id.min:
                ...
                return true;
            case R.id.symphonic:
                Intent intent4 = new Intent(Screen.this, Screen4.class);
                startActivity(intent4);
                finish();

                return true;
            case R.id.rock:
                Intent intent3 = new Intent(Screen.this, Screen3.class);
                startActivity(intent3);
                finish();

                return true;
            case R.id.folk:
                Intent intent2 = new Intent(Screen.this, Screen2.class);
                startActivity(intent2);
                finish();

                return true;
            case R.id.advanced:
                Intent intent5 = new Intent(Screen.this, Sequencer.class);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: // нажатие
                ...
                if(x>mWindowWidth/10 && (x<mWindowWidth/2) && y>0 && (y<0.4*mWindowHeight) )
                {
                ...
                if(x>0 && (x<mWindowWidth/4) && (y>mWindowHeight/2.5) && (y<(2*mWindowHeight/3)) )
                {
                    sp.play(soundIdlatintriangle, 1, 1, 0, 0, 1);
                }


                if((x>mWindowWidth/2) && (x<(mWindowWidth - (mWindowWidth/10))) && (y>mWindowHeight/4) && (y<mWindowHeight/2) )
                {
   ...
   //     TextView textView = (TextView)findViewById(R.id.textView2);
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        view.setBackgroundResource(R.drawable.kit);
...
//состояния датчика.
        ...
        soundIdbassdrum = sp.load(this, R.raw.bassdrum, 1);
        soundIdtom12 = sp.load(this, R.raw.tom12, 1);
        soundIdhihatopen = sp.load(this, R.raw.hihatopen, 1);
