...
public class Screen3 extends AppCompatActivity implements SensorEventListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.accel:
                Intent intent = new Intent(Screen3.this, SensorTestActivity.class);
            ...
            case R.id.min:
                ...
                Intent intent2 = new Intent(Screen3.this, Screen.class);
                startActivity(intent2);
                finish();

                return true;
            case R.id.symphonic:
                Intent intent4 = new Intent(Screen3.this, Screen4.class);
            ...
            case R.id.rock:
                ...
                return true;
            case R.id.folk:
                Intent intent3 = new Intent(Screen3.this, Screen2.class);
                ...
                return true;
            case R.id.advanced:
                Intent intent5 = new Intent(Screen3.this, Sequencer.class);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: // нажатие
                ...
                if(x>0.66*mWindowWidth && y>0.75*mWindowHeight )
                {
                ...
                if(x>0 && (x<mWindowWidth/3) && y>(0.3*mWindowHeight) && y<0.55*mWindowHeight)
                {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        view.setBackgroundResource(R.drawable.kit222);
...
//состояния датчика.
        ...
        soundIdfloortom = sp.load(this, R.raw.rock_tom4, 1);
        soundIdcrashcimbal = sp.load(this, R.raw.rock_crash, 1);
        soundIdsnaredrumunmuffled = sp.load(this, R.raw.rock_snare, 1);
        soundIdsnaredrummuffled = sp.load(this, R.raw.snaredrummuffled, 1);
        soundIdhihatclosed = sp.load(this, R.raw.hihatclosed, 1);
        soundIdlatintriangle = sp.load(this, R.raw.rock_hat2, 1);
        soundIdbassdrum = sp.load(this, R.raw.rock_bochka, 1);
        soundIdtom12 = sp.load(this, R.raw.rock_tom2, 1);
        soundIdhihatopen = sp.load(this, R.raw.rock_hat, 1);
        soundIdtom8 = sp.load(this, R.raw.rock_tom1, 1);

        sidTatar  = sp.load(this, R.raw.rock_hat3, 1);
        sidUdo  = sp.load(this, R.raw.rock_bochka2, 1);
        sidBongo = sp.load(this, R.raw.rock_crash2, 1);
        sidTamtam = sp.load(this, R.raw.rock_crash3, 1);
